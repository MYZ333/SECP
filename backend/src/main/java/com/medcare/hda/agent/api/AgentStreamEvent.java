...
public record AgentStreamEvent(
        @Schema(description = "事件类型：meta/stage/risk/citation/delta/done/error") String type,
    ...
    public static AgentStreamEvent meta(String sessionId) {
        return new AgentStreamEvent("meta", sessionId, null, null, null, null, null, null, java.util.List.of());
    }

    public static AgentStreamEvent meta(String sessionId, String traceId, java.util.List<String> categories) {
        return new AgentStreamEvent("meta", sessionId, null, null, null, null, null, traceId, categories);
    }

    public static AgentStreamEvent stage(AgentStageUpdate update) {
        return new AgentStreamEvent("stage", null, update.message(), update.stage(), update.status(), null, null, null, java.util.List.of());
    }

    public static AgentStreamEvent risk(String level, String message) {
        return new AgentStreamEvent("risk", null, message, "SAFETY_CHECK", "COMPLETED", level, null, null, java.util.List.of());
    }

    public static AgentStreamEvent citation(AgentCitation citation) {
        return new AgentStreamEvent("citation", null, null, null, null, null, citation, null, java.util.List.of());
    }

    public static AgentStreamEvent delta(String content) {
        return new AgentStreamEvent("delta", null, content, null, null, null, null, null, java.util.List.of());
    }

    public static AgentStreamEvent done() {
        return new AgentStreamEvent("done", null, null, null, null, null, null, null, java.util.List.of());
    }

    public static AgentStreamEvent error(String message) {
        return new AgentStreamEvent("error", null, message, null, null, null, null, null, java.util.List.of());
    }
}
